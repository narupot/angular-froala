...
!function(a) {
    ...
    a.FE.MODULES.markers = function(b) {
        ...
        function d(d, e, f) {
            ...
            try {
                ...
                j.insertNode(c(e, f)),
                e === !0 && d.collapsed)
                    for (g = b.$el.find('span.fr-marker[data-type="true"][data-id="' + f + '"]'),
                    i = g.get(0).nextSibling; i && i.nodeType === Node.TEXT_NODE && 0 === i.textContent.length; )
                        a(i).remove(),
                        i = g.nextSibling;
                if (e === !0 && !d.collapsed && (g = b.$el.find('span.fr-marker[data-type="true"][data-id="' + f + '"]').get(0),
                i = g.nextSibling,
    ...
    a.FE.MODULES.selection = function(b) {
        ...
        function j() {
            ...
            for (c = f.length - 1; c > 0; c--)
                a(f[c]).find(f).length && ("LI" != f[c].tagName || 1 == f[c].children.length && f.indexOf(f[c].children[0]) >= 0) && f.splice(c, 1);
            return f
        }
        function k() {
            if (b.$wp) {
                ...
                for (c = 0; c < d.length; c++)
                    if (d[c].startContainer !== b.doc) {
                        ...
                        b.el.normalize(),
                        b.browser.safari && !g && (a = b.doc.createRange(),
                        a.setStartAfter(h),
                        a.setEndBefore(i),
                        f.push(a))
                    }
        ...
        function v() {
            ...
            for (c = 0; c < f.length; c++)
                for (var g = f[c]; !d(g) && !b.node.isBlock(g.parentNode) && !b.$el.is(g.parentNode); )
                    a(g.parentNode).before(g);
            var h = b.$el.find('.fr-marker[data-type="false"]');
            for (c = 0; c < h.length; c++) {
                for (var i = h[c]; !e(i) && !b.node.isBlock(i.parentNode) && !b.$el.is(i.parentNode); )
    ...
    a.FE.MODULES.clean = function(b) {
        ...
        function n(c) {
            ...
            if (b.opts.htmlAllowComments || c.nodeType != Node.COMMENT_NODE)
                if (c.tagName && c.tagName.match(H))
                    ...
                    if (f)
                        for (var h = f.length - 1; h >= 0; h--) {
                            var i = f[h]
                              ...
                              , k = null;
                            "style" == i.nodeName && b.opts.htmlAllowedStyleProps.length && (k = i.nodeValue.match(J)),
                            j && k ? i.nodeValue = g(k.join(";")) : j && ("style" != i.nodeName || k) || c.removeAttribute(i.nodeName)
                        }
                }
            else
        ...
        function o(a) {
            for (var c = b.node.contents(a), d = 0; d < c.length; d++)
                c[d].nodeType != Node.TEXT_NODE && o(c[d]);
            n(a)
        }
        function p(a) {
            var b = a.innerHTML;
        ...
        function D() {
            if (b.html.defaultTag())
                for (var c = b.el.querySelectorAll("li > " + b.html.defaultTag()), d = c.length - 1; d >= 0; d--) {
                    var e = c[d];
                    e.previousSibling && !b.node.isEmpty(e) && a("<br>").insertAfter(e.previousSibling),
    ...
    a.FE.MODULES.spaces = function(b) {
        function c(c, d) {
            ...
            if ("PRE" != h.tagName) {
                d && (g = g.replace(/[\f\n\r\t\v ]{2,}/g, " "),
                f && "BR" !== f.tagName && !b.node.isBlock(f) || !b.node.isBlock(h) || (g = g.replace(/[\f\n\r\t\v ]{1,}$/g, "")),
                e && "BR" !== e.tagName && !b.node.isBlock(e) || !b.node.isBlock(h) || (g = g.replace(/^[\f\n\r\t\v ]{1,}/g, "")),
                ...
                (!f || b.node.isBlock(f) || f.nodeType == Node.ELEMENT_NODE && b.win.getComputedStyle(f) && "block" == b.win.getComputedStyle(f).display) && (i = i.replace(/ $/, a.FE.UNICODE_NBSP)),
    ...
    a.FE.MODULES.html = function(b) {
            ...
            if (c) {
                ...
                for (d = 0; d < h.length; d++) {
                    ...
                    if (i) {
                        var j = i.nextSibling
                          , k = i.previousSibling;
                        i && g.indexOf(i) < 0 && b.node.isBlock(i) && g.push(i),
                        k && b.node.isBlock(k) && g.indexOf(k) < 0 && g.push(k),
                        j && b.node.isBlock(j) && g.indexOf(j) < 0 && g.push(j)
                    }
                }
            } else
            ...
            e) {
                for (var f = b.doc.createDocumentFragment(), g = null, h = !1, i = a.firstChild; i; ) {
                    ...
                    if (i.nodeType == Node.ELEMENT_NODE && (b.node.isBlock(i) || b.opts.htmlDoNotWrapTags.indexOf(i.tagName.toLowerCase()) >= 0 && !b.node.hasClass(i, "fr-marker")))
                        ...
                        h = !1),
                        g.appendChild(i),
                        h || b.node.hasClass(i, "fr-marker") || i.nodeType == Node.TEXT_NODE && 0 === k.replace(/ /g, "").length || (h = !0))
                    }
                    i = j
                }
                a.innerHTML = "",
        ...
        function j(a, c, d, e) {
            return !!b.$wp && ("undefined" == typeof a && (a = !1),
        ...
        function r(c, d) {
            ...
            if (e && (b.node.isBlock(e) || b.node.isElement(e)) && ["TD", "TH"].indexOf(e.tagName) < 0) {
                for (var f = c.previousSibling, g = c.nextSibling; f && f.nodeType == Node.TEXT_NODE && 0 === f.textContent.replace(/\n|\r/g, "").length; )
                    f = f.previousSibling;
                f && e && "BR" != f.tagName && !b.node.isBlock(f) && !g && e.textContent.replace(/\u200B/g, "").length > 0 && f.textContent.length > 0 && !b.node.hasClass(f, "fr-marker") && (b.el == e && !g && b.opts.enter == a.FE.ENTER_BR && b.browser.msie || (d && b.selection.save(),
                c.parentNode.removeChild(c),
                d && b.selection.restore()))
            }
        }
        ...
        function v() {
            b.core.isEmpty() && (null != c() ? b.el.querySelector(f()) || b.el.querySelector(b.opts.htmlDoNotWrapTags.join(":not(.fr-marker),") + ":not(.fr-marker)") || (b.core.hasFocus() ? (b.$el.html("<" + c() + ">" + a.FE.MARKERS + "<br/></" + c() + ">"),
        ...
        function z(c) {
            ...
            if (b.opts.fullPage) {
                ...
                b.$html.attr(k),
                b.iframe_document.doctype.parentNode.replaceChild(p(j, b.iframe_document), b.iframe_document.doctype)
            } else
                b.$el.html(d);
        ...
        function D(a, c) {
            ...
            b.opts.fullPage ? (d = q(b.iframe_document),
        ...
        function I(c, d, e) {
            ...
            f = f.replace(/\r|\n/g, " "),
            c.indexOf('class="fr-marker"') < 0 && (f = G(f)),
        ...
        function J(c) {
            ...
            do {
                ...
                for (var i = 0; i < g.length; i++) {
                    ...
                    if (d != j) {
                        var k = j.textContent;
                        0 === j.children.length && 1 === k.length && 8203 == k.charCodeAt(0) && (a(j).remove(),
                        h = !0)
                    }
                }
            } while (h)
    ...
    a.FE.MODULES.placeholder = function(b) {
        function c() {
            ...
            if (j.length && j[0].nodeType == Node.ELEMENT_NODE) {
                var l = a(j[0]);
                !b.opts.toolbarInline && b.ready && (c = b.helpers.getPX(l.css("margin-top")),
    ...
    a.FE.MODULES.cursor = function(b) {
        ...
        function j() {
            ...
            for (var k = j.parentNode; k && !b.node.isElement(k); ) {
                if ("false" === k.getAttribute("contenteditable"))
                    return a(j).replaceWith(a.FE.MARKERS),
                    b.selection.restore(),
                    !1;
            ...
            if (l) {
                var m = l.textContent;
                m && m.length && 8203 == m.charCodeAt(m.length - 1) && (1 == m.length ? a(l).remove() : (l.textContent = l.textContent.substr(0, m.length - 1),
                l.textContent.length && 55357 == l.textContent.charCodeAt(l.textContent.length - 1) && (l.textContent = l.textContent.substr(0, l.textContent.length - 1))))
            }
        ...
        function p(c, d, e) {
            ...
            if (null == h)
                g = b.html.defaultTag(),
                g && b.node.isElement(c.parentNode) ? a(c).replaceWith("<" + g + ">" + a.FE.MARKERS + "<br></" + g + ">") : a(c).replaceWith((b.node.isEmpty(c.parentNode, !0) ? "" : "<br/>") + a.FE.MARKERS + "<br/>");
            else {
                var i = c
                  , j = "";
        ...
        function s(e) {
            ...
            c(f) ? !g(f) || e || h ? p(f, e, h) : b.cursorLists._endEnter(f) : d(f) ? !g(f) || e || h ? q(f, e, h) : b.cursorLists._startEnter(f) : !g(f) || e || h ? r(f, e, h) : b.cursorLists._middleEnter(f),
            o(),
            b.opts.htmlUntouched || (b.html.fillEmptyBlocks(!0),
    ...
    a.FE.MODULES.keys = function(b) {
        ...
        function q(c) {
            ...
            c && (c.which == a.FE.KEYCODE.ENTER || c.which == a.FE.KEYCODE.BACKSPACE || c.which >= 37 && c.which <= 40 && !b.browser.msie) && (c.which == a.FE.KEYCODE.BACKSPACE && z || o()),
            b.html.cleanBRs(!0, !0);
            var d = function(a) {
                if (!a)
                    return !1;
        ...
        function u(c) {
            var d = c.which;
            return !!(r(c) || d >= 37 && d <= 40 || !t(d) && d != a.FE.KEYCODE.DELETE && d != a.FE.KEYCODE.BACKSPACE && d != a.FE.KEYCODE.ENTER && 229 != d) || (A || (B = b.snapshot.get(),
        ...
        function v(a) {
            var c = a.which;
            return !!(r(a) || c >= 37 && c <= 40) || void (B && A && (b.undo.saveStep(B),
            B = null))
        }
        function w() {
            A && (clearTimeout(A),
    ...
    a.FE.MODULES.data = function(a) {
        ...
        function h() {
            ...
            k = j.find("> a"),
            void ("rtl" == a.opts.direction && j.css("left", "auto").css("right", 0)))
        }
        function i() {
    ...
    a.FE.MODULES.paste = function(b) {
        ...
        function e(a) {
            ...
            a && a.clipboardData && a.clipboardData.getData) {
                ...
                if (b.helpers.isArray(d))
                    ...
                    c = d;
                if (p = "",
                q = a.clipboardData.getData("text/rtf"),
                /text\/html/.test(c) ? p = a.clipboardData.getData("text/html") : /text\/rtf/.test(c) && b.browser.safari ? p = q : /text\/plain/.test(c) && !this.browser.mozilla && (p = b.html.escapeEntities(a.clipboardData.getData("text/plain")).replace(/\n/g, "<br>")),
                "" !== p)
                    return j(),
        ...
        function f() {
            ...
            b.events.disableBlur(),
            p = null,
            r ? r.html("") : (r = a('<div contenteditable="true" style="position: fixed; top: 0; left: -9999px; height: 100%; width: 0; word-break: break-all; overflow:hidden; z-index: 9999; line-height: 140%;" tabIndex="-1"></div>'),
            b.$box.after(r),
        ...
        function j() {
            ...
            null === p && (p = r.get(0).innerHTML,
            b.selection.restore(),
            b.events.enableBlur());
            var j = i(p)
              , l = b.events.chainTrigger("paste.beforeCleanup", p);
            if (l && "string" == typeof l && (p = l),
            p.toLowerCase().indexOf("<body") >= 0 && (p = p.replace(/[.\s\S\w\W<>]*<body[^>]*>[\s]*([.\s\S\w\W<>]*)[\s]*<\/body>[.\s\S\w\W<>]*/gi, "$1"),
            p = p.replace(/([^>])\n([^<])/g, "$1 $2")),
            !j) {
                var n = b.opts.htmlAllowedStyleProps;
                b.opts.htmlAllowedStyleProps = b.opts.pasteAllowedStyleProps,
                b.opts.htmlAllowComments = !1,
                p = b.clean.html(p, b.opts.pasteDeniedTags, b.opts.pasteDeniedAttrs),
            ...
            var t = !1;
            if (p.indexOf('id="docs-internal-guid') >= 0 && (p = p.replace(/^.* id="docs-internal-guid[^>]*>(.*)<\/b>.*$/, "$1"),
            t = !0),
            j && !b.wordPaste && (p = p.replace(/^\n*/g, "").replace(/^ /g, ""),
            0 === p.indexOf("<colgroup>") && (p = "<table>" + p + "</table>"),
            p = g(p),
            p = m(p)),
            b.opts.pastePlain && (p = h(p)),
            l = b.events.chainTrigger("paste.afterCleanup", p),
            "string" == typeof l && (p = l),
            "" !== p) {
                ...
                var x = u.children;
                if (1 == x.length && ["OL", "UL"].indexOf(x[0].tagName) >= 0 && (x[0].outerHTML = x[0].innerHTML),
                !t) {
                ...
                if (b.opts.enter == a.FE.ENTER_BR)
                    for (d = u.querySelectorAll("p, div"),
                    c = d.length - 1; c >= 0; c--)
                        e = d[c],
                        e.outerHTML = e.innerHTML + (e.nextSibling && !b.node.isEmpty(e) ? "<br>" : "");
                else if (b.opts.enter == a.FE.ENTER_DIV)
                    for (d = u.getElementsByTagName("p"),
                    c = d.length - 1; c >= 0; c--)
                        e = d[c],
                        e.outerHTML = "<div>" + e.innerHTML + "</div>";
                p = u.innerHTML,
                b.html.insert(p, !0)
            }
            k(),
    ...
    a.FE.MODULES.button = function(b) {
        ...
        function e(c) {
            ...
            !f) {
                ...
                b.opts.toolbarBottom ? e.css("bottom", b.$tb.height() - c.position().top) : e.css("top", c.position().top + c.outerHeight())
            }
            ...
            e.offset().left + e.outerWidth() > b.$sc.offset().left + b.$sc.outerWidth() && e.css("margin-left", -(e.offset().left + e.outerWidth() - b.$sc.offset().left - b.$sc.outerWidth())),
        ...
        function m(c, d) {
            ...
            b.node.hasClass(c.get(0), "fr-popup") ? a.merge(w, c.find(".fr-btn").toArray()) : a.merge(v, c.find(".fr-btn").toArray()),
    ...
    a.FE.MODULES.modals = function(b) {
        ...
        function e(c, e, f) {
            if (b.shared.$overlay || (b.shared.$overlay = a('<div class="fr-overlay">').appendTo("body")),
            m = b.shared.$overlay,
        ...
        function g(c) {
            if (n[c]) {
                ...
                d.show(),
                m.show(),
                a(b.o_doc).find("body").addClass("prevent-scroll"),
                b.helpers.isMobile() && a(b.o_doc).find("body").addClass("fr-mobile"),
        ...
        function h(c, d) {
            if (n[c]) {
                ...
                e.hide(),
                m.hide(),
                a(f.o_doc).find("body").removeClass("prevent-scroll fr-mobile"),
        ...
        function s(c) {
            ...
            return {
                ...
                _preventFocus: function(c) {
                    ...
                    b.browser.safari && "mousedown" == c.type && a(f).is("input[type=file]") && e.events.disableBlur();
    ...
    a.FE.MODULES.position = function(b) {
        ...
        function d(a, c, d) {
            ...
            if (!b.helpers.isMobile() && b.$tb && a.parent().get(0) != b.$tb.get(0)) {
                ...
                f + c + e > b.$sc.offset().top + h && a.parent().offset().top + g > 0 ? (c = g,
    ...
    a.FE.MODULES.toolbar = function(b) {
        ...
        function q() {
            return b.$sc = a(b.opts.scrollableContainer),
